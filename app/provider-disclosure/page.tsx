  ...
  return (
    <main className="px-4 py-14 sm:px-6 lg:px-8">
      <article className="mx-auto max-w-3xl rounded-md border border-tide/16 bg-mist/44 p-6 shadow-sm shadow-water/12">
        <p className="text-xs font-bold uppercase tracking-[0.18em] text-tide">Disclosure</p>
        <h1 className="mt-4 font-serif text-5xl text-leaf">Independent provider network</h1>
