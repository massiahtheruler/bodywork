...
export default async function TherapistPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <main className="px-4 py-14 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-4xl rounded-md border border-charcoal-olive/10 bg-bone/72 p-6 md:p-8">
        <p className="text-xs font-bold uppercase tracking-[0.18em] text-clay">Provider architecture</p>
        <h1 className="mt-4 font-serif text-5xl text-charcoal-olive">Provider profile placeholder</h1>
