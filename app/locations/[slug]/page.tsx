  ...
  return (
    <main className="px-4 py-14 sm:px-6 lg:px-8">
      ...
      <div className="mx-auto max-w-7xl">
        <p className="text-xs font-bold uppercase tracking-[0.18em] text-tide">{brand.serviceArea}</p>
        <h1 className="mt-4 max-w-4xl font-serif text-5xl leading-tight text-leaf md:text-6xl">{location.headline}</h1>
        ...
        <section className="mt-14">
          <h2 className="font-serif text-4xl text-leaf">Available service paths</h2>
